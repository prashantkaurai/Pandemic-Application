      ...
      <div className="container py-20 flex flex-col md:flex-row md:items-center justify-between gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-400 xl:max-w-[400px]">
            We are a team of designers and developers that create high quality websites and applications for our clients. 
            We are passionate about our work and we are always looking for new challenges.
          </p>
        </div>
        {/* social icons */}
