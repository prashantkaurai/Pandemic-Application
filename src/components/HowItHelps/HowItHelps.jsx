        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          >
            ...
            <p className=" text-gray-400 mt-4">
              Here are some of the ways our app can help you. We are constantly working on new features 
              and improvements to make your experience better. We are always looking for feedback and suggestions to improve our app.
            </p>
            <p className="text-sm text-gray-400 mt-4">
              Know more about how our app can help you {" "}
